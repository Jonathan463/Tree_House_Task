...
import com.treehouseapp.service.serviceInterfaces.AdminService;
...
public class AdminServiceImpl implements AdminService {
    ...
    public AdminServiceImpl(UserRepository userRepository,
                            ...
                            FavoriteFlowerRepository favoriteFlowerRepository,
    ...
    private List<String> topFavoriteFlowers(Integer pageNo, Integer pageSize) {
        Pageable paging = PageRequest.of(pageNo, pageSize);
        List<Long> mealsId = favoriteFlowerRepository.findTopByMenuidOrderByMenuidDesc(paging);
    ...
    public AppStatisticsResponse getStatistics(Integer pageNo, Integer pageSize) {
        ...
        List<String> list = topFavoriteFlowers(pageNo, pageSize);
